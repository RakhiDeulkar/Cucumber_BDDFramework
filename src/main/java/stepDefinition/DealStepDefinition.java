...
//		driver.findElement(By.xpath(".//*[@name='email']")).sendKeys(data.get(0).get(0));
...
//	   driver.findElement(By.xpath(".//*[@name='title']")).sendKeys(dealValues.get(0).get(0)); // row.column
//	   driver.findElement(By.xpath(".//*[@name='amount']")).sendKeys(dealValues.get(0).get(1));
//	   driver.findElement(By.xpath(".//*[@name='probability']")).sendKeys(dealValues.get(0).get(2));
//	   driver.findElement(By.xpath(".//*[@name='commission']")).sendKeys(dealValues.get(0).get(3));
